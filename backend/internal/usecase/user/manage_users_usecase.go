...
type UserManagementUsecase interface {
	Login(ctx context.Context, input *inputdata.LoginInputData) (*outputdata.LoginOutputData, error)
...
func (uc *ManageUsersUsecase) Login(ctx context.Context, input *inputdata.LoginInputData) (*outputdata.LoginOutputData, error) {
