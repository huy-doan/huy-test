...
// ToPayoutRecordDTO converts a PayoutRecord domain model to a PayoutRecordDTO
func ToPayoutRecordDTO(record *modelPayoutRecord.PayoutRecord) *dto.PayoutRecordDTO {
	if record == nil {
		return nil
	}

	return &dto.PayoutRecordDTO{
		ID:                    record.ID,
...
// ToPayoutRecordModel converts a PayoutRecordDTO to a PayoutRecord domain model
func ToPayoutRecordModel(dtoObj *dto.PayoutRecordDTO) *modelPayoutRecord.PayoutRecord {
	if dtoObj == nil {
		return nil
	}
...
func ToPayoutRecordDTOs(records []*modelPayoutRecord.PayoutRecord) []*dto.PayoutRecordDTO {
	if records == nil {
		return nil
	}

	result := make([]*dto.PayoutRecordDTO, len(records))
...
func ToPayoutRecordModels(dtos []*dto.PayoutRecordDTO) []*modelPayoutRecord.PayoutRecord {
	if dtos == nil {
		return nil
	}
