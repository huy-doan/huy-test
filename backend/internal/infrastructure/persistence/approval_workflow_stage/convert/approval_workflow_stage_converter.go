...
// ToApprovalWorkflowStageDTO converts an ApprovalWorkflowStage domain model to an ApprovalWorkflowStageDTO
func ToApprovalWorkflowStageDTO(stage *modelApprovalWorkflowStage.ApprovalWorkflowStage) *dto.ApprovalWorkflowStageDTO {
	if stage == nil {
		return nil
	}

	return &dto.ApprovalWorkflowStageDTO{
		ID:             stage.ID,
...
// ToApprovalWorkflowStageModel converts an ApprovalWorkflowStageDTO to an ApprovalWorkflowStage domain model
func ToApprovalWorkflowStageModel(dtoObj *dto.ApprovalWorkflowStageDTO) *modelApprovalWorkflowStage.ApprovalWorkflowStage {
	if dtoObj == nil {
		return nil
	}
...
func ToApprovalWorkflowStageDTOs(stages []*modelApprovalWorkflowStage.ApprovalWorkflowStage) []*dto.ApprovalWorkflowStageDTO {
	if stages == nil {
		return nil
	}

	result := make([]*dto.ApprovalWorkflowStageDTO, len(stages))
...
func ToApprovalWorkflowStageModels(dtos []*dto.ApprovalWorkflowStageDTO) []*modelApprovalWorkflowStage.ApprovalWorkflowStage {
	if dtos == nil {
		return nil
	}
