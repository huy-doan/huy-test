...
SEEDS_DIR="./database/seeds/master"
...
case "$1" in
  ...
  "status")
    ...
    ;;
  *)
    echo "Usage: $0 {migrate:up|migrate:down|seed-master:up|seed-master:down|status}"
    echo "  migrate:up   - Run all pending migrations"
    echo "  migrate:down - Rollback last migration"
    echo "  seed-master:up      - Apply all seed data"
    echo "  seed-master:down    - Remove seed data"
